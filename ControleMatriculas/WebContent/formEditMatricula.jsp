...
<form action="editMatricula.jsp">
	...
	<input type="text" name="nomeAluno" id="sNomeAluno" size="30" maxlength="40" value="<%=m.getAluno().getNome() %>"/><br/>
	<label for="sCpfAluno">CPF</label>
	<input type="text" name="cpfAluno" id="sCpfAluno" size="14" maxlength="11" value="<%=m.getAluno().getCpf() %>"/><br/>
	<label for="srgAluno">RG</label>
	<input type="text" name="rgAluno" id="sRgAluno" size="14" maxlength="20" value="<%=m.getAluno().getRg() %>"/><br/>
  	<label for="sNascAluno">Data de Nascimento</label>
	<input type="date" name="nascAluno" id="sNascAluno" size="10" maxlength="12" value="<%=fd.format(m.getAluno().getDataNasc()) %>"/><br/>
	<label for="sEmailAluno">E-mail</label>
	<input type="email" name="emailAluno" id="sEmailAluno" size="30" maxlength="40" value="<%=m.getAluno().getEmail() %>"/><br/>
	<label for="sTelAluno">Telefone</label>
	<input type="tel" name="telAluno" id="sTelAluno" size="12" maxlength="12" value="<%=m.getAluno().getTelefone1() %>"/><br/>
	<label for="sCelAluno">Celular</label>
	<input type="tel" name="celAluno" id="sCelAluno" size="12" maxlength="12" value="<%=m.getAluno().getTelefone2() %>"/><br/>
	<fieldset>
	...
	<input type="text" name="cpfResp" id="sCpfResp" size="14" maxlength="11" value="<%=m.getAluno().getResponsavel().getCpf() %>"/><br/>
	<label for="srgResp">RG</label>
	<input type="text" name="rgResp" id="sRgResp" size="14" maxlength="20" value="<%=m.getAluno().getResponsavel().getRg() %>"/><br/>
  	<label for="sNascResp">Data de Nascimento</label>
	<input type="date" name="nascResp" id="sNascResp" size="10" maxlength="12" value="<%=fd.format(m.getAluno().getResponsavel().getDataNasc()) %>"/><br/>
	<label for="sEmailResp">E-mail</label>
	<input type="email" name="emailResp" id="sEmailResp" size="30" maxlength="40" value="<%=m.getAluno().getResponsavel().getEmail() %>"/><br/>
	<label for="sTelResp">Telefone</label>
	<input type="tel" name="telResp" id="sTelResp" size="12" maxlength="12" value="<%=m.getAluno().getResponsavel().getTelefone1() %>"/><br/>
	<label for="sCelResp">Celular</label>
	<input type="tel" name="celResp" id="sCelResp" size="12" maxlength="12" value="<%=m.getAluno().getResponsavel().getTelefone2() %>"/><br/>
	<label for="sParentecoResp">Parentesco</label>
	<input type="text" name="parentescoResp" id="sParentescoResp" size="12" maxlength="20" value="<%=m.getAluno().getResponsavel().getParentesco() %>"/><br/>
	<fieldset>
