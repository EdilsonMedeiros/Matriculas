				...
				<div class="col-lg-8 mx-auto">
					<fieldset>
						...
						<form action="inputTurma.jsp">
							<label for="sNomet">Nome da Turma</label> <input type="text"
								name="cNomeT" id="sNomeT" maxlength="10" /><br /> <label
								for="sVagas">Nº de Vagas</label> <input type="number"
								name="cVagas" id="sVagas" maxlength="5" /><br /> <label
								for="sSala">Sala</label> <input type="number" name="cSala"
								id="sSala" maxlength="5" /><br /> <label>Escolha um
								Turno</label> <select name="seleTurno" id="turnoSele">
