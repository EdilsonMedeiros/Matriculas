				...
				<div class="col-lg-8 mx-auto">
					<fieldset>
						...
						<form action="inputUsuario.jsp">
							<label for="sUsuario">Criando Usuário</label> <input type="email"
								name="cUsuario" id="sUsuario" maxlength="30" /><br /> <label
								for="sSenha">Criando Senha</label> <input type="password"
								name="cSenha" id="sSenha" maxlength="14" /><br /> <label>Escolha
