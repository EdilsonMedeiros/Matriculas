				...
				<div class="col-lg-8 mx-auto">
					...
					<fieldset>
						...
						<form action="editDisciplina.jsp">
							<input type="hidden" name="id" maxlength="30"
								value="<%=d.getId()%>" /><br /> <label for="sDisciplina">Nome</label>
							<input type="text" name="cDisciplina" id="sDisciplina"
								maxlength="30" value="<%=d.getNome()%>" /><br /> <label
								for="sCargaHoraria">Carga Horária</label> <input type="number"
								name="cCargaHoraria" id="sCargaHoraria" size="5" maxlength="4"
								value="<%=d.getCargaHoraria()%>" /><br /> <label>Ementa</label>
